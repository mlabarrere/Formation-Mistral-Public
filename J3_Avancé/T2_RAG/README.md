...
**Notebook** : [`NB_T2a_rag_graphrag.ipynb`](NB_T2a_rag_graphrag.ipynb), 65 cellules, ~120 min,
...
Le module a un smoke test : `uv run python "J3_Avancé/T2_RAG/vins_jura.py"`.
...
- **`ragas` ne s'importe plus** dans l'environnement unifié : sa dépendance `litellm` réclame
  ...
  ⚠️ Conséquence au-delà de ce thème : le bloc d'évaluation de `NB_T1a` est sous `try/except` et
...
| **Yao et al. (2022)** « ReAct » [arXiv:2210.03629](https://arxiv.org/abs/2210.03629) | rappel de T1, pour situer T2 |
